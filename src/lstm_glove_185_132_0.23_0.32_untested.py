...
with codecs.open(TRAIN_DATA_FILE, encoding='utf-8') as f:
    ...
    header = next(reader)
    for values in tqdm(reader, total=404290):
...
with codecs.open(TEST_DATA_FILE, encoding='utf-8') as f:
    reader = csv.reader(f, delimiter=',')
    header = next(reader)
    for values in tqdm(reader, total=2345796):
...
def jaccard(row):
    wic = set(str(row['question1']).lower().split()).intersection(set(str(row['question2']).lower().split()))
    uw = set(str(row['question1']).lower().split()).union(str(row['question2']).lower().split())
    if len(uw) == 0:
        uw = [1]
    return 0 if np.isnan((len(wic) / len(uw))) else (len(wic) / len(uw))

def common_words(row):
    return len(set(str(row['question1']).lower().split()).intersection(set(str(row['question2']).lower().split())))

def total_unique_words(row):
    return len(set(str(row['question1']).lower().split()).union(str(row['question2']).lower().split()))

def total_unq_words_stop(row, stops):
    return len([x for x in set(str(row['question1']).lower().split()).union(str(row['question2']).lower().split()) if x not in stops])

def wc_diff(row):
    return abs(len(str(row['question1']).lower().split()) - len(str(row['question2']).lower().split()))

def wc_ratio(row):
    l1 = len(str(row['question1']).lower().split())*1.0
    l2 = len(str(row['question2']).lower().split())
    if l2 == 0:
        return 0
    if l1 / l2:
        return l2 / l1
...
def wc_diff_unique(row):
    return abs(len(set(str(row['question1']).lower().split())) - len(set(str(row['question2']).lower().split())))

def wc_ratio_unique(row):
    l1 = len(set(str(row['question1']).lower().split())) * 1.0
    l2 = len(set(str(row['question2']).lower().split()))
    if l2 == 0:
        return 0
    if l1 / l2:
        return l2 / l1
...
def wc_diff_unique_stop(row, stops=None):
    return abs(len([x for x in set(str(row['question1']).lower().split()) if x not in stops]) - len([x for x in set(str(row['question2']).lower().split()) if x not in stops]))

def wc_ratio_unique_stop(row, stops=None):
    l1 = len([x for x in set(str(row['question1']).lower().split()) if x not in stops])*1.0
    l2 = len([x for x in set(str(row['question2']).lower().split()) if x not in stops])
    if l2 == 0:
        return 0
    if l1 / l2:
        return l2 / l1
...
def same_start_word(row):
    if not row['question1'] or not row['question2']:
        return np.nan
    return int(str(row['question1']).lower().split()[0] == str(row['question2']).lower().split()[0])

def char_diff(row):
    return abs(len(''.join(str(row['question1']).lower().split())) - len(''.join(str(row['question2']).lower().split())))

def char_ratio(row):
    l1 = len(''.join(str(row['question1']).lower().split()))
    l2 = len(''.join(str(row['question2']).lower().split()))
    if l2 == 0:
        return 0
    if l1 / l2:
        return l2 / l1
...
def char_diff_unique_stop(row, stops=None):
    return abs(len(''.join([x for x in set(str(row['question1']).lower().split()) if x not in stops])) - len(''.join([x for x in set(str(row['question2']).lower().split()) if x not in stops])))
